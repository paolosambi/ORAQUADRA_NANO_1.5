...
void drawPongStandalone();  // forward declaration
...
void initPong() {
  ...
  if (isDualDisplayActive()) {
    ...
    drawPongStandalone();
    Serial.println("[PONG] Multi-Display non attivo - mostrato avviso");
    return;
  }
  #else
  drawPongStandalone();
  Serial.println("[PONG] Multi-Display non disponibile - mostrato avviso");
  return;
  #endif
