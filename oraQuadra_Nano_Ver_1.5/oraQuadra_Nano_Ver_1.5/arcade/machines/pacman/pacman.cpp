// ============================================================================
// PAC-MAN Machine Implementation - Adapted from Galag for oraQuadra Nano
// Uses ArcadeInput instead of Input, no SD ROM loading
// ============================================================================

#include "pacman.h"
#include "../../arcade_bridge.h"

// Clear shared macros from other game .cpp files
#include "../../arcade_undef.h"

// Direct flash ROM access (no SD card loading)
#define ROM_ARR      pacman_rom
#define TILEMAP_ARR  pacman_tilemap
#define SPRITES_ARR  pacman_sprites
#define COLORMAP_ARR pacman_colormap
#define WAVE_ARR     pacman_wavetable
...
const unsigned short *pacman::tileRom(unsigned short addr) {
  return TILEMAP_ARR[memory[addr]];
}
