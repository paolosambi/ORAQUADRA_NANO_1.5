...
static inline void setCarry(struct i8048_state_S *state, i8048_bool carry) {
...
static void pop(struct i8048_state_S *state, i8048_bool restoreState) {
...
// conditional jump
static inline void cjump(struct i8048_state_S *state, i8048_bool condition) {    
