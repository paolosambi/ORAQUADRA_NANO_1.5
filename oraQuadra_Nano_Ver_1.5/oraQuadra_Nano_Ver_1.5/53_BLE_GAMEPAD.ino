...
void bleGamepadInit() {
  ...
  // Run BLE stack init in background task (NimBLEDevice::init can take 200-500ms)
  xTaskCreatePinnedToCore(bleGpInitTask, "bleGpInit", 4096, NULL, 1, NULL, 0);
}
