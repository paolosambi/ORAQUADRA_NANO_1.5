...
bool AudioOutputI2S::SetPinout()
{
    ...
    i2s_pin_config_t pins = {
        .mck_io_num = I2S_PIN_NO_CHANGE, // Disabilita MCLK completamente (non usa GPIO 0)
        .bck_io_num = bclkPin,
        .ws_io_num = wclkPin,
...
bool AudioOutputI2S::stop()
{
  ...
  #ifdef ESP32
    i2s_zero_dma_buffer((i2s_port_t)portNo);
    // IMPORTANTE: disinstalla il driver I2S per permettere la reinstallazione
    // senza questo, begin() fallisce con "register I2S object to platform failed"
